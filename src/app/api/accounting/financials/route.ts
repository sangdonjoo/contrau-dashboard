...
const COMPANY_META: Record<string, { id: string; name: string; nameKo: string }> = {
  ...
  CTPLUS:      { id: 'ctplus',   name: 'CT Plus',      nameKo: 'CT Plus' },
  ECCM:        { id: 'eccm',     name: 'Eco CM',       nameKo: 'Eco CM' },
  ENTOFLOW:    { id: 'entoflow', name: 'Entoflow',     nameKo: 'Entoflow' },
  CTSF:        { id: 'ctsf',     name: 'CT SF',        nameKo: 'CT SF' },
  CONTRAU_KR:  { id: 'kr_hq',   name: 'CT Eco KR',    nameKo: 'CT Eco KR' },
  CINV:        { id: 'cinv',     name: 'CT Inv',       nameKo: 'CT Inv' },
  CTAT:        { id: 'ctat',     name: 'CT Aqua',      nameKo: 'CT Aqua' },
  CTNTINV:     { id: 'ctntinv',  name: 'CT NT Inv',    nameKo: 'CT NT Inv' },
  CTECONT:     { id: 'ctecont',  name: 'CT Eco NT',    nameKo: 'CT Eco NT' },
  GAINV:       { id: 'gainv',    name: 'GA Inv',       nameKo: 'GA Inv' },
  SAVN:        { id: 'savn',     name: 'SA VN',        nameKo: 'SA VN' },
};
